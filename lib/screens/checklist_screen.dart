...
class _ChecklistScreenState extends State<ChecklistScreen> {
  ...
  void _processImage() {
    ...
    Future.delayed(const Duration(seconds: 2), () {
      ...
      setState(() {
        _items.insert(0, ChecklistItem(id: DateTime.now().millisecondsSinceEpoch.toString() + "1", title: "Plátanos de Canarias"));
        _items.insert(0, ChecklistItem(id: DateTime.now().millisecondsSinceEpoch.toString() + "2", title: "Pan integral"));
        _items.insert(0, ChecklistItem(id: DateTime.now().millisecondsSinceEpoch.toString() + "3", title: "Huevos camperos (Docena)"));
        _items.insert(0, ChecklistItem(id: DateTime.now().millisecondsSinceEpoch.toString() + "4", title: "Leche desnatada"));
      });
